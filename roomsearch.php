...
$query = "SELECT room.roomID,roomname,roomtype,beds FROM room, booking WHERE room.roomID NOT IN (SELECT roomID from booking) OR (room.roomID = booking.roomID AND (checkoutDate < '$startdate' OR checkinDate > '$enddate'))";
